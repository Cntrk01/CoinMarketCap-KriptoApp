...
import com.example.coinmarketcapcriptoapp.databinding.RecyclerRowLayoutBinding
...
class HomeRecyclerAdapter(private val listener:ItemClickListener):RecyclerView.Adapter<HomeRecyclerAdapter.MViewHolder>() {
    ...
    class MViewHolder(private val binding:RecyclerRowLayoutBinding):RecyclerView.ViewHolder(binding.root){
        ...
        companion object{
            fun from(parent:ViewGroup):MViewHolder{
                ...
                val binding=RecyclerRowLayoutBinding.inflate(layoutInf,parent,false)
    ...
    fun setList(newList:List<Data>){
        coins=newList //coins yukarda boştu biz main içerisinde veri göndererek içini data ile dolduracağız ve burada boş liste dolu olcak
